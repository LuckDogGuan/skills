# 顾问 JR23144 (贺六浑) (Rank 6) 核心量化研究论点与发帖 (Writings & Insights)

> 本文档汇集了顾问 JR23144 (贺六浑) (Rank 6) 在论坛分享的量化研究主帖与独到见解。已集成图片 OCR 文本并进行了过滤与脱敏处理。
...
> I:
> b'{"user": {"id":"顾问 顾问 JR23144 (贺六浑) (Rank 6) (贺六浑) (Rank 6)"} , "token" : {"expiry" : 86400.0}
> permissions
> [ "BEFORE
> 亏
> 过
