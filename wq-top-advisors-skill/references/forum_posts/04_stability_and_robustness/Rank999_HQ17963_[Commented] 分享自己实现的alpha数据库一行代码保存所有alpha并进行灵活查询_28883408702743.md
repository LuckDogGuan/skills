...
[顾问 LW67640 (小虎) (Rank 24)](/hc/en-us/profiles/28067010930967-顾问 LW67640 (小虎) (Rank 24)) 你好，这是由于数据写入过程中，程序被中止（如ctrl+c）导致的。尝试将region_universe_info.bak.pkl替换region_universe_info.pkl，应该可以修复该问题。若还有报错，则请删除sim_alpha_database文件夹并重新拉取所有因子。
