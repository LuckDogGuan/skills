...
[👉来自其他同学的补丁👉自己更改和完善后的wqb库 – WorldQuant BRAIN](../顾问 LW67640 (小虎) (Rank 24)/[Commented] 自己更改和完善后的wqb库代码优化.md)
...
这个回测程序中断后，再继续跑的话，如何截断呢？是在这里设置截断数值参数吗？ 
> [!NOTE] [图片 OCR 识别内容]
> /LICI  1 CeI
> atp1a5
> C
> resps
> await
> wqbs.concurrent_simulate(alphas,
> 3, log_gap=l0)
> print ( 'alpha_ids:
> 米
> resp.json ( ) [ 'alpha' ]
