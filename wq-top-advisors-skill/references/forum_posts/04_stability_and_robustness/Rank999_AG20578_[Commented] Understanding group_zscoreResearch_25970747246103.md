...
While the  [Z-score]([L2] Understanding Z-Score OperatorsResearch_24912183913495.md)  is a powerful measure for standardizing data and the  [ts_zscore](Understanding ts_zscoreResearch_25502968546583.md)  extends this concept to time-series data, the concept can be further extended to grouped data using the group_zscore operator.
