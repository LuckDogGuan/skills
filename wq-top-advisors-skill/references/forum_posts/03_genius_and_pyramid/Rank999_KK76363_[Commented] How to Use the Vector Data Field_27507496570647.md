...
It might also be helpful to check out the Learn section article:  [Vector Datafields](https://platform.worldquantbrain.com/learn/documentation/advanced-topics/vector-datafields)  and  [[BRAIN TIPS] How to use vector operators and vector data fields]([L2] [BRAIN TIPS] How to use vector operators and vector data fields_14902471049239.md)
