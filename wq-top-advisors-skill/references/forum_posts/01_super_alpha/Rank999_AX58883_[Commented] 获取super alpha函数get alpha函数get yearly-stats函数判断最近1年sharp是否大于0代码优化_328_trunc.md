...
感谢大佬的提醒，我是看到一篇帖子是要判断最近几年的sharp情况一个是避免最近几年的收益负数，另一个就是看是不是在最近几年也能保持好的sharp，不过这里的函数就只是对最后一年做判断了，简单的一刀切  [顾问 JR23144 (贺六浑) (Rank 6)](/hc/en-us/profiles/28844048981143-顾问 JR23144 (贺六浑) (Rank 6))
