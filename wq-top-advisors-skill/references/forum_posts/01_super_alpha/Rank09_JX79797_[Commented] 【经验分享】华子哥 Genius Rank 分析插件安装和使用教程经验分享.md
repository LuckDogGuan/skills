...
### 评论 #7 (作者: 顾问 JX79797 (华子哥/华子) (Rank 9), 时间: 9个月前)
...
这个40是初始为了保险由课代表设置的，随后就沿用了。现在你可以参考 HQ17963大佬的 [25Q3顾问提交情况播报（每日更新）](../顾问 JR23144 (贺六浑) (Rank 6)/[Commented] 25Q3顾问提交情况播报每日更新.md) 文章获取Q3满足的人数，从而调整提交个数
...
### 评论 #22 (作者: 顾问 QP72475 (点塔王) (Rank 84), 时间: 9个月前)
