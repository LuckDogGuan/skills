...
For instance, x can be a variable of the aggregated returns (see  [4 ways for you to calculate returns](../顾问 DN45758 (Rank 79)/[Commented] 4 ways for you to calculate returnsResearch.md)  to learn more), while y could be any field you hypothesize can predict these returns. Experiment with different delays for y to discover optimal results.
