...
- **链接**: https://support.worldquantbrain.com[Commented] Understanding ts_zscoreResearch_25502968546583.md
- **作者**: AG20578
- **发布时间/热度**: 1年前, 得票: 10
...
Hi TT55495! There is a post about calculating returns (please refer to the first comment under this post it is more readable -  **[4 Ways to Calculate Returns]([L2] 4 ways for you to calculate returnsResearch_23977710448663.md)** )
