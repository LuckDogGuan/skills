...
- **链接**: https://support.worldquantbrain.com[Commented] 用python ast提取表达式中operator和datafield的方法代码优化_30870358077463.md
...
提供一个新的思路，如果是走一二三阶段的路子，可以试着用backfill来抓取（当然，向量类型每种向量运算符都算一个），详细的可以参考： [如何统计得到的字段数？如何抓取多地区因子一起检验？ – WorldQuant BRAIN]([L2] 如何统计得到的字段数如何抓取多地区因子一起检验代码优化_28754183939351.md)
