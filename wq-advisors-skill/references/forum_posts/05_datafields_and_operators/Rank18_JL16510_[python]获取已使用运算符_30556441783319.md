...
- **链接**: https://support.worldquantbrain.com[python]获取已使用运算符_30556441783319.md
...
@ [顾问 WL27618 (Rank 97)](/hc/en-us/profiles/29059197295767-顾问 WL27618 (Rank 97))  最近分享了一篇用ast解析操作符和字段的帖子，参见 [用python ast提取表达式中operator和datafield的方法 – WorldQuant BRAIN]([L2] 用python ast提取表达式中operator和datafield的方法代码优化_30870358077463.md) ，这样可以不用手动维护dt_oper和dt_alpha了
