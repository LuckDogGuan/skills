...
- **链接**: https://support.worldquantbrain.comPYTHON alpha的ast解析和语法检查经验分享_40175357844503.md
...
[用python ast提取表达式中operator和datafield的方法](用python ast提取表达式中operator和datafield的方法代码优化_30870358077463.md)
