...
对于论坛中的模版本身的op已经有点多问题，再套一个会过拟合问题确实会有点，但我其实都是使用论坛中的简单模板比如 [[Alpha Template] Time-Series Sentiment Comparison Template – WorldQuant BRAIN](../顾问 CC40930 (Rank 95)/[Commented] [Alpha Template] Time-Series Sentiment Comparison TemplateAlpha Template.md) ，毕竟最近一段时间都是为了PPAC努力。
