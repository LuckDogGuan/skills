...
- **链接**: https://support.worldquantbrain.com[L2] 如何用cursor使用MCP的简易教程Answered_34174261927191.md
- **作者**: ZH41150
- **发布时间/热度**: 10 months ago, 得票: 54

## 帖子正文

第一步去官网下载cursor，认准这个图标 
> [!NOTE] [图片 OCR 识别内容]
> CUrsOT
...
> General
> Connect 回
> Connect GitHub for Background Agents;
> Bot and enhanced codebase context
> O0 Chat
> 爿 Tab
> 
> Slack
...
> Command
> "C:
> IUsers | IAdministrator
> IAppData | |Local | IPrograms | IPython
> IPython312 | Ipython
> exe
> 12
> args
...
> Forum MCP
> Server
> Forum interaction and knowledge extraction
> tools.
> Provides glossary
> acCesS,
> forum post
> reading〉
> and  community features. Credentials
> are
> stored in
> user_config.json in the
> same direc
> 16
> 17
> 18
...
> 预讨完成时间:现在可以测试论坛珈能
> 安装成功 !
> chromedriver-autoinstaller 已成功安装 (版本0.6.4 )。
> 现在让我重新测试论坛的连通性
> Called search_forum_posts
> 论坛连通性测试功
> 处理时间:约45秒
> 预完F间: 已完成
> 测试结果 :
> 连接砌功
> WorldQuant BRAIN论坛功能完全正常
> 搜索结果摘要 :
> 找到3个相关帖子
> 搜索关键词: "test"
> 响h桐:正常
> 数据完整性:完整
> 返回的帖子包括
> 1. "浅探对robust test结果的观测方法" (61票  9评论)
> 2."关于robustness test的代码复现" (32票 0评论)
> 3.
> [代码优化] self-correlation检测改进Strain。 test结果筛选" (票
> 5评论)
> 功能状态确认 :
> 论坛撰索珈能-正常
> Chrome WebDriver
...
> 正常
> 中支持-正常
> 现在您可以正常使用所有WorldQuant BRAIN论坛功能了
> 需要我帮您搜
> 索特定的内容或进行其他操作吗?
 缺失的文件，他会咨询你是否安装，缺啥装啥，装好他会自动重新测试一遍
...
> [!NOTE] [图片 OCR 识别内容]
> -1丹人云111巧帖丁
> Called read_Torum_POst
> Parameters;
> article id"
> "25775603889431--AIpha-Template-How-can-yOL
> RESUII:
> {"resuIt" ;{
> error
> Could
...
您好，大佬，我想问下我在cursor配置完，路径也对，但是这样的，这个是怎么回事尼 
> [!NOTE] [图片 OCR 识别内容]
...
> 8
> 芾选器
> 326-01-14  15:09:38.568 [error]
> [uooelf4da WorldQuant
> BRAIN Forum
> Inctions Server Starting-
> te:
> Forum tools
> are
> nOW
> integrated in
> the main platform_functions.Py
> is file provides the Forumclient
> Class
> for internal
> USe
> 326-81-14 15.89.38.711
> [info] client closed for command
> 326-01-14  15:11:42.997 [info] Handling Createclient
> action
 请问大佬这个怎么办呢？
