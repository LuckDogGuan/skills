...
1、准确率问题：我之前提交过一个帖子（ [基于mcp点亮short Interest](../顾问 HP65370 (Rank 93)/[Commented] 【Alpha灵感】基于MCP提交的3个Short Interest 因子.md) ），很多人问我，deepseek这么强大吗？实际上不是的，关键是提示词，你要说明白要做什么，每一步要非常明确才行，要不然准确率会是负数。
...
### 评论 #14 (作者: 顾问 YH25030 (Rank 31), 时间: 8个月前)
