...
- **链接**: https://support.worldquantbrain.com[Commented] 基于相关系数的剪枝方法简易实现代码优化_31441951570071.md
- **作者**: EC12049
- **发布时间/热度**: 1年前, 得票: 23
...
您好，请问两两之间的相关系数是依据什么计算的？在“ [本地0误差计算自相关性]([Commented] 本地0误差计算自相关性【即插即用版】代码优化_31343962309143.md) ”的文章中是需要查询Alpha的pnl数据来计算相关性的
...
在文章“ [本地0误差计算自相关性]([Commented] 本地0误差计算自相关性【即插即用版】代码优化_31343962309143.md) ”的相关性计算是基于两个因子 **最近四年** 的每日盈亏数据的Pearson相关系数计算,其中每日盈亏数据即当前pnl减去前一日pnl----这在 [本地0误差计算自相关性]([Commented] 本地0误差计算自相关性【即插即用版】代码优化_31343962309143.md) 的源码中有所体现
...
文章 [从Gold跃升到GrandMaster——选好模板和相关性剪枝可能是关键]([L2] 从Gold跃升到GrandMaster选好模板和相关性剪枝可能是关键论坛精选_31280678526615.md) 有所提及 
> [!NOTE] [图片 OCR 识别内容]
