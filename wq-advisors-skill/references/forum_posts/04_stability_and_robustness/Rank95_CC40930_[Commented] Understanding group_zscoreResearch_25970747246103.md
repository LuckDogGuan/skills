...
- **链接**: https://support.worldquantbrain.com[Commented] Understanding group_zscoreResearch_25970747246103.md
- **作者**: AG20578
- **发布时间/热度**: 1年前, 得票: 11

## 帖子正文

While the  [Z-score]([Commented] Understanding Z-Score OperatorsResearch_24912183913495.md)  is a powerful measure for standardizing data and the  [ts_zscore]([Commented] Understanding ts_zscoreResearch_25502968546583.md)  extends this concept to time-series data, the concept can be further extended to grouped data using the group_zscore operator.
