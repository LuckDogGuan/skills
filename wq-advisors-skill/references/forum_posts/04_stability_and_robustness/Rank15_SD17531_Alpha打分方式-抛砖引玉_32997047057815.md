...
- **链接**: https://support.worldquantbrain.comAlpha打分方式-抛砖引玉_32997047057815.md
...
我的除了对于基本指标（sharpe,margin,return,fitness)给予一定权重，也会获取Performance Comparison里的数据（提交该因子后对指标是改善还是更不好），以及self-correlation，product-correlation (我一般是1/SC*系数）这样来算；最后再把它们都加总。

你说的NEUT, MaxTrade ON加分也是很好的建议~~
