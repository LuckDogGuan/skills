...
- **链接**: https://support.worldquantbrain.com[Commented] 【MCP Workflow】一个自动化找alpha的工作流分享_34670122621207.md
- **作者**: FF56620
...
可结合之前的帖子  [[L2] 来自MCP的operator指北终于看懂了大多数的平台operator_34208186164631.md]([L2] 来自MCP的operator指北终于看懂了大多数的平台operator_34208186164631.md)
...
[BW16434](/hc/en-us/profiles/33778608267031-BW16434)  就是平台文档，也可参考之前的发帖  [来自MCP的operator指北]([L2] 来自MCP的operator指北终于看懂了大多数的平台operator_34208186164631.md)
...
[【随时随地MCP】一个在手机上远程使用MCP的方案]([Commented] 【随时随地MCP】一个在手机上远程使用MCP的方案_34726879588247.md)
