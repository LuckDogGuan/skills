...
根据之前 [点亮sentiment塔](../顾问 QL47372 (Rank 36)/[Commented] 【Community Leader -因子构造 】AI严选条件动量模版点塔SentimentAlpha Template.md) 的经验，我们发现：相关性算子+FAST neutralization的组合比较适合处理sentiment的数据。考虑到news数据和sentiment数据经常有很强的关联性，所以自然地，我们想到在EUR的news塔也使用一下这个组合，看是不是可以跑出一些不错的alpha。
