...
我是采用非手搓先随机生成的方法，参考（copy）自 [顾问 JL16510 (Rank 18)](/hc/en-us/profiles/25889743296151-顾问 JL16510 (Rank 18))  的 [多线程遍历回测super alpha – WorldQuant BRAIN](../顾问 JL16510 (Rank 18)/多线程遍历回测super alpha代码优化.md) 与 [HW93328](/hc/en-us/profiles/28771941793815-HW93328)  的 [Super alpha全自动回测代码--开箱即用！](../顾问 JX79797 (Rank 9)/[Commented] Super alpha全自动回测代码--开箱即用代码优化.md)
...
感谢ZZ佬的分享，阅读完本贴感觉收获良多，再对super alpha 的selection 理解更加深刻的同时，了解到了更多的combo模板，目前我也是用 自 [顾问 JL16510 (Rank 18)](/hc/en-us/profiles/25889743296151-顾问 JL16510 (Rank 18))  的 [多线程遍历回测super alpha – WorldQuant BRAIN](../顾问 JL16510 (Rank 18)/多线程遍历回测super alpha代码优化.md) 与 [HW93328](/hc/en-us/profiles/28771941793815-HW93328)  的 [Super alpha全自动回测代码--开箱即用！](../顾问 JX79797 (Rank 9)/[Commented] Super alpha全自动回测代码--开箱即用代码优化.md) 的结合，非常好用！感谢大佬们的无私奉献。
