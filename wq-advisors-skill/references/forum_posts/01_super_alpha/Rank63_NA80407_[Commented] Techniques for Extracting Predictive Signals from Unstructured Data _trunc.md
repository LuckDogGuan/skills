...
To extract some good signals using datasets like social media or news sentiment refer to some Worldquant's links on how to use them. Here are few links
 [../顾问 AM60509 (Rank 61)/[Commented] Getting started with News DatasetsResearch.md](../顾问 AM60509 (Rank 61)/[Commented] Getting started with News DatasetsResearch.md) 

 [../顾问 CC40930 (Rank 95)/[Commented] Getting started with Social Media DatasetsResearch.md](../顾问 CC40930 (Rank 95)/[Commented] Getting started with Social Media DatasetsResearch.md)
