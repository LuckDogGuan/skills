...
### 评论 #1 (作者: TT55495, 时间: 1 year ago)

Thank you for the detailed explanation of high capacity alphas and the significance of low turnover! How could variable thresholds based on factors like liquidity, market capitalization, or volatility be applied to improve the performance of the hump operation? Can you think of a scenario where adjusting these thresholds for specific instruments or groups could significantly enhance alpha capacity?
