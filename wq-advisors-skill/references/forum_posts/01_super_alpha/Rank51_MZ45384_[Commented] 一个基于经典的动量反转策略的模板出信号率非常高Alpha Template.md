...
顾问 MZ45384 (Rank 51)1、norm是常规的数据处理，有些字段用这种方式数据处理更好，有些字段用另一种，又或者有些字段不需要数据处理也有可能。我没做出很确切的模板范围。2、时间窗口可以是月度，季度，半年，年度。3、高turnover是这个策略的局限，降turn的运算符效果不好，关键还是得从策略上出发。目前还没有思路。====================================================================================keep moving====================================================================================
