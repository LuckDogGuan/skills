...
To learn more about what ts_product(1 + returns, 5) - 1 means, check out post  [4 ways to calculate returns](../顾问 DN45758 (Rank 79)/[Commented] 4 ways for you to calculate returnsResearch.md)
